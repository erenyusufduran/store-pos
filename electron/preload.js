...
contextBridge.exposeInMainWorld("api", {
  ...
  getPopularProducts: (limit) =>
    ipcRenderer.invoke("get-popular-products", limit),
  ...
  getProductsCount: (params) =>
    ipcRenderer.invoke("get-products-count", params),
  ...
  getSalesByDateRange: (startDate, endDate) =>
    ipcRenderer.invoke("get-sales-by-date-range", startDate, endDate),
  ...
  changePassword: (newPassword) =>
    ipcRenderer.invoke("change-password", newPassword),
  forgetPassword: (newPassword) =>
    ipcRenderer.invoke("forget-password", newPassword),
  getAdminPassword: () => ipcRenderer.invoke("get-admin-password"),

  // Supabase operations
  isOnline: () => ipcRenderer.invoke("is-online"),
  fetchSupabaseData: ({ tableName, columns }) =>
    ipcRenderer.invoke("fetch-supabase-data", { tableName, columns }),
  syncSupabase: () => ipcRenderer.invoke("sync-supabase"),

  // Clean database operations
  cleanDatabase: () => ipcRenderer.invoke("clean-database"),
});
